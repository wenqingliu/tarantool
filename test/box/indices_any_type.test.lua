...
i2_2 = s2:create_index('my_space3_idx2', {type='TREE', parts={4, 'STRING', 5, 'SCALAR'}, unique=true})
...
i4_1 = s4:create_index('my_space5_idx1', {type='HASH', parts={1, 'SCALAR', 2, 'INTEGER', 3, 'NUMBER'}, unique=true})
